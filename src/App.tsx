...
import { RedirectAnalyzerPage } from './pages/RedirectAnalyzerPage';
...
function AppContent() {
  ...
  if (!isAuthenticated && currentPage === 'redirect-analyzer') {
    return <RedirectAnalyzerPage onNavigate={setCurrentPage} />;
  }
