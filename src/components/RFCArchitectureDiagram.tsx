...
export function RFCArchitectureDiagram() {
  return (
    <div className="w-full max-w-5xl mx-auto p-4 sm:p-8 bg-[#161b22] border border-gray-700 rounded-lg font-mono text-xs sm:text-sm overflow-x-auto">
      {/* Title */}
      <div className="mb-6 pb-4 border-b border-gray-700">
        <h3 className="text-emerald-400 font-bold text-base sm:text-lg">RFC-Style Architecture: CNAME Delegation Flow</h3>
        <p className="text-gray-500 mt-1 text-xs sm:text-sm">Zero private key exposure • Automated ACME validation</p>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col md:flex-row items-center gap-4">
          <div className="flex-1 w-full bg-[#0d1117] border border-gray-700 rounded p-3 sm:p-4">
            <div className="text-blue-400 font-bold mb-2">1. DNS Provider</div>
            <div className="text-gray-300 text-xs space-y-1">
              <div>Type: CNAME</div>
              <div className="break-all">Host: _acme-challenge.yourdomain.com</div>
              <div className="break-all">Value: yourdomain.com.dcv.keylessssl.dev</div>
            </div>
          </div>
          <ArrowRight size={32} weight="bold" className="text-emerald-500 flex-shrink-0 rotate-90 md:rotate-0" />
        ...
        <div className="flex flex-col md:flex-row items-center gap-4">
          ...
          {/* Step 4: Result */}
          <div className="flex-1 w-full bg-[#0d1117] border border-emerald-900/50 rounded p-3 sm:p-4">
      ...
      <div className="mt-6 pt-4 border-t border-gray-700">
        <div className="flex items-start gap-3 bg-emerald-950/30 border border-emerald-800/30 rounded p-3">
          <div className="text-emerald-400 font-bold text-xs sm:text-sm">🔒 Security:</div>
